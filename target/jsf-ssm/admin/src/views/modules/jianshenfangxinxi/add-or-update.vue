<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="区域名称" prop="jsfname">
                        <el-input v-model="ruleForm.jsfname"
                                  placeholder="健身房区域名称" clearable :readonly="ro.jsfname"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="区域名称" prop="jsfname">
                            <el-input v-model="ruleForm.jsfname"
                                      placeholder="健身房区域名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
				<el-col :span="12">
				    <el-form-item class="input" v-if="type!='info'" label="区域信息" prop="jsfmessage">
				        <el-input v-model="ruleForm.jsfmessage"
				                  placeholder="健身房区域信息" clearable :readonly="ro.jsfmessage"></el-input>
				    </el-form-item>
				    <div v-else>
				        <el-form-item class="input" label="区域信息" prop="jsfmessage">
				            <el-input v-model="ruleForm.jsfmessage"
				                      placeholder="健身房区域信息" readonly></el-input>
				        </el-form-item>
				    </div>
				</el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jsfPhoto" label="区域图片" prop="jsfPhoto">
                        <file-upload
                                tip="健身房区域图片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.jsfPhoto?ruleForm.jsfPhoto:''"
                                @change="jsfPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jsfPhoto" label="区域图片" prop="jsfPhoto">
                            <img style="margin-right:20px;" v-bind:key="index"
                                 v-for="(item,index) in ruleForm.jsfPhoto.split(',')" :src="item" width="100"
                                 height="100">
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            ...
            var validatePhone = (rule, value, callback) => {
                if (!value) {
                    ...
                    callback(new Error("请输入正确的健身房信息号码"));
                } else {
                    callback();
                }
            };
            ...
            return {
                ...
                rules: {
                    jsfname: [
                        {required: true, message: '健身区域名称不能为空', trigger: 'blur'},
                    ],
                    jsfmessage: [
                    ],
                    jlidTypes: [],
        ...
        methods: {
            ...
            init(id, type) {
                ...
                if (this.type == 'info' || this.type == 'else') {
                    ...
                    for (var o in obj) {
                        if (o == 'jsfname') {
                            this.ruleForm.jsfname = obj[o];
                            this.ro.jsfname = true;
                            continue;
                        }
                        if (o == 'password') {
                        ...
                        if (o == 'jlidTypes') {
                            this.ruleForm.jlidTypes = obj[o];
                            this.ro.jlidTypes = true;
                            continue;
                        }
                        if (o == 'zhuanye') {
                        ...
                        if (o == 'jsfPhoto') {
                            this.ruleForm.jsfPhoto = obj[o];
                            this.ro.jsfPhoto = true;
                            continue;
                        }
                        if (o == 'zhuangtai') {
            ...
            jsfPhotoUploadChange(fileUrls) {
                this.ruleForm.jsfPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
            addEditStyleChange() {
                this.$nextTick(() => {
