<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="教练名称" prop="jlname">
                        <el-input v-model="ruleForm.jlname"
                                  placeholder="教练名称" clearable :readonly="ro.jlname"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="教练名称" prop="jlname">
                            <el-input v-model="ruleForm.jlname"
				...
				<el-col :span="12">
				    <el-form-item class="input" v-if="type!='info'" label="账号" prop="account">
				        <el-input v-model="ruleForm.account"
				                  placeholder="请输入账号" clearable :readonly="ro.account"></el-input>
				    </el-form-item>
				    <div v-else>
				        <el-form-item class="input" label="账号" prop="account">
				            <el-input v-model="ruleForm.account"
				                      placeholder="请输入账号" readonly></el-input>
				        </el-form-item>
				    </div>
				</el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="密码" prop="password">
                       <el-input v-model="ruleForm.password"
                                 placeholder="请输入账号" clearable :readonly="ro.password"></el-input>
                    </el-form-item>
                    <div v-else>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    jlname: [
                        {required: true, message: '健身教练名称不能为空', trigger: 'blur'},
                    ],
                    account: [
