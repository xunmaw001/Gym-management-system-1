<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
	  <el-col :span="12">
	      <el-form-item class="select" v-if="type!='info'" label="会员卡名" prop="hykname">
	              <el-input v-model="ruleForm.hykname"
	                        placeholder="会员名称" clearable :readonly="ro.hykname"></el-input>
	      </el-form-item>
	      <div v-else>
	          <el-form-item class="input" label="会员卡名" prop="hykname">
	             <el-input v-model="ruleForm.hykname"
	                       placeholder="会员名称" clearable :readonly="ro.hykname"></el-input>
	          </el-form-item>
	      </div>
	  ...
	  <el-col :span="12">
	      <el-form-item class="select" v-if="type!='info'" label="费用" prop="cost">
			  <el-input v-model="ruleForm.cost"
			            placeholder="费用" clearable :readonly="ro.cost"></el-input>
	      </el-form-item>
	      <div v-else>
	          <el-form-item class="input" label="费用" prop="cost">
				  <el-input v-model="ruleForm.cost"
				            placeholder="费用" clearable :readonly="ro.cost"></el-input>
	          </el-form-item>
	      </div>
