                ...
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '教练名称' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.jlname" placeholder="教练名称"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.jlname" placeholder="教练名称"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 0" v-model="searchForm.jlname" placeholder="教练名称"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item>
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('jiaolianxinxi','修改') && contents.tableBtnIcon == 0" type="primary"
                            ...
                            <el-button v-if="isAuth('jiaolianxinxi','删除') && contents.tableBtnIcon == 0" type="danger"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.jlname != '' && this.searchForm.jlname != undefined) {
                    params['jlname'] = this.searchForm.jlname
                }
                this.$http({
